...
import (
	...
	icqkeeper "github.com/cosmos/ibc-go/v6/modules/apps/32-icq/keeper"
...
type SimApp struct {
	*baseapp.BaseApp
	...
	ScopedICQMockKeeper       capabilitykeeper.ScopedKeeper
...
func NewSimApp(
	...
	keys := sdk.NewKVStoreKeys(
		...
		evidencetypes.StoreKey, ibctransfertypes.StoreKey, icacontrollertypes.StoreKey, icahosttypes.StoreKey, icqtypes.StoreKey, capabilitytypes.StoreKey,
	...
	*/
	...
	app.mm.SetOrderBeginBlockers(
		...
		paramstypes.ModuleName, vestingtypes.ModuleName, icatypes.ModuleName, icqtypes.ModuleName, ibcfeetypes.ModuleName, ibcmock.ModuleName, group.ModuleName,
	)
	app.mm.SetOrderEndBlockers(
		...
		upgradetypes.ModuleName, vestingtypes.ModuleName, icatypes.ModuleName, icqtypes.ModuleName, ibcfeetypes.ModuleName, ibcmock.ModuleName, group.ModuleName,
	)
	...
	app.mm.SetOrderInitGenesis(
		...
		icatypes.ModuleName, icqtypes.ModuleName, ibcfeetypes.ModuleName, ibcmock.ModuleName, feegrant.ModuleName, paramstypes.ModuleName, upgradetypes.ModuleName,
	...
	app.ScopedICQMockKeeper = scopedICQMockKeeper
