...
func (cs ClientState) Validate() error {
	...
	if len(cs.ChainId) > comettypes.MaxChainIDLen {
		return sdkerrors.Wrapf(ErrInvalidChainID, "chainID is too long; got: %d, max: %d", len(cs.ChainId), comettypes.MaxChainIDLen)
	}
